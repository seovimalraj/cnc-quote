-- Admin CMS and activity feed foundations

-- Ensure enum exists for CMS status
DO $$
BEGIN
...
-- Activity feed table sourced from audit events
...
-- Backfill from existing audit events (limit to recent history)
...
-- Synchronize future audit_events inserts into admin_activity_events
...
-- Seed baseline content if tables are empty
