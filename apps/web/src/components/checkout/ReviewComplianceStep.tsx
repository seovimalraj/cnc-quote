  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setCompliance(prev => ({ ...prev, itar_onshore_only: checked as boolean }))
                }
              />
              <div className="space-y-1">
                <Label htmlFor="itar_onshore_only" className="text-sm font-medium">
                  ITAR/EAR-Controlled Data
                </Label>
                <p className="text-sm text-gray-600">
                  This order contains ITAR/EAR-controlled data. Route to U.S. suppliers only.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setCompliance(prev => ({ ...prev, dfars_materials: checked as boolean }))
                }
              />
              <div className="space-y-1">
                <Label htmlFor="dfars_materials" className="text-sm font-medium">
            ...
            <div className="flex items-start space-x-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setCompliance(prev => ({ ...prev, export_ack: checked as boolean }))
                }
              />
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-600">
                  I certify I am authorized to export/import these items (where applicable).
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Selecting ITAR disables international lead-time options and shipping addresses outside approved regions.
            </p>
          </div>
        </div>
        ...
        {/* Document Upload */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Attach Documentation (optional)</h3>
        ...
        <div className="flex justify-between pt-6 border-t">
          ...
          <Button onClick={handleSave} disabled={saving || !compliance.export_ack}>
