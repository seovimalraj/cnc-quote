...
export default function AccountPage() {
  ...
  useEffect(() => {
    ...
    } else if (['profile', 'organization', 'team', 'api-tokens', 'notifications', 'templates'].includes(lastSegment)) {
  ...
  const loadAccountData = async () => {
    try {
      ...
      const [profileRes, orgRes, membersRes] = await Promise.all([
        ...
        api.get<{ members: Member[]; total: number }>(`/org/members?limit=${ITEMS_PER_PAGE}`)
      ]);
  ...
  const getTabIcon = (tab: string) => {
    switch (tab) {
      ...
      case 'api-tokens': return <KeyIcon className="w-4 h-4" />;
      case 'notifications': return <BellIcon className="w-4 h-4" />;
      case 'templates': return <DocumentTextIcon className="w-4 h-4" />;
      default: return null;
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Account & Organization</h1>
          <p className="text-gray-600 mt-2">
            Manage your profile, organization settings, team members, and preferences.
          </p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{membersTotal}</p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    {organization?.itar_mode && (
                      <Badge variant="destructive" className="text-xs">ITAR</Badge>
                    )}
                    {organization?.onshore_only && (
                      <Badge variant="secondary" className="text-xs">Onshore</Badge>
                    )}
                    {!organization?.itar_mode && !organization?.onshore_only && (
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange}>
          ...
          <TabsContent value="profile" className="mt-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Configure your personal profile and authentication settings.</p>
                <Button
                  className="mt-4"
          ...
          <TabsContent value="organization" className="mt-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Manage your organization's details, defaults, and compliance settings.</p>
                <Button
                  className="mt-4"
          ...
          <TabsContent value="team" className="mt-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Invite team members and manage roles and permissions.</p>
                <Button
                  className="mt-4"
          ...
          <TabsContent value="api-tokens" className="mt-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Create and manage API tokens for programmatic access.</p>
                <Button
                  className="mt-4"
          ...
          <TabsContent value="templates" className="mt-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Manage your saved material, finish, and inspection templates.</p>
                <Button
                  className="mt-4"
