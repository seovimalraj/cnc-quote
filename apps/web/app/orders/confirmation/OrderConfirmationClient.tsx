    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Thank you for your order. We'll send you shipping updates at {order.billing_info.email}.</p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">${(order.amount / 100).toFixed(2)} {order.currency.toUpperCase()}</span>
              </div>
              <div className="flex justify-between">
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600">
                    ...
                    {order.shipping_info.address.line2 && `, ${order.shipping_info.address.line2}`}
                  </p>
                  <p className="text-gray-600">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your parts will be manufactured according to your specifications.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">We'll ship your order and provide tracking information.</p>
                </div>
              </div>
            </CardContent>
          </Card>
