...
import { 
  Users, Search, Filter, Mail, Phone, Building2, Calendar, DollarSign, Eye, 
  Plus, Edit, MapPin, Package, TrendingUp, Star, MessageSquare, FileText,
...
export default function AdminCustomersPage() {
  ...
  const customers: Customer[] = [
    { 
      id: 1, name: 'John Smith', email: 'john@acme.com', phone: '+1 (555) 123-4567', 
      company: 'Acme Manufacturing', industry: 'Aerospace', address: '123 Industry Blvd',
      city: 'Los Angeles', state: 'CA', zipcode: '90001',
      joined: '2024-01-15', lastOrder: '2024-11-03', orders: 45, totalSpent: 425000, 
      avgOrderValue: 9444, status: 'vip', paymentTerms: 'Net 30', creditLimit: 100000, rating: 4.9
    },
    { 
      id: 2, name: 'Sarah Johnson', email: 'sarah@techcorp.com', phone: '+1 (555) 234-5678', 
      company: 'TechCorp Industries', industry: 'Electronics', address: '456 Tech Park',
      city: 'San Francisco', state: 'CA', zipcode: '94102',
      joined: '2024-02-20', lastOrder: '2024-11-04', orders: 38, totalSpent: 380000, 
      avgOrderValue: 10000, status: 'active', paymentTerms: 'Net 45', creditLimit: 75000, rating: 4.7
    },
    { 
      id: 3, name: 'Michael Brown', email: 'mike@globalrobotics.com', phone: '+1 (555) 345-6789', 
      company: 'Global Robotics Ltd', industry: 'Robotics', address: '789 Automation Way',
      city: 'Boston', state: 'MA', zipcode: '02101',
      joined: '2024-03-10', lastOrder: '2024-11-01', orders: 32, totalSpent: 298000, 
      avgOrderValue: 9312, status: 'active', paymentTerms: 'Net 30', creditLimit: 50000, rating: 4.8
    },
    { 
      id: 4, name: 'Robert Davis', email: 'robert@aerospace.com', phone: '+1 (555) 456-7890', 
      company: 'AeroSpace Dynamics', industry: 'Aerospace', address: '321 Flight Road',
      city: 'Seattle', state: 'WA', zipcode: '98101',
      joined: '2023-11-05', lastOrder: '2024-11-05', orders: 52, totalSpent: 625000, 
      avgOrderValue: 12019, status: 'vip', paymentTerms: 'Net 60', creditLimit: 150000, rating: 4.9
    },
    { 
      id: 5, name: 'Lisa Anderson', email: 'lisa@meddevice.com', phone: '+1 (555) 567-8901', 
      company: 'MedDevice Inc', industry: 'Medical', address: '555 Healthcare Plaza',
      city: 'Chicago', state: 'IL', zipcode: '60601',
      joined: '2024-04-12', lastOrder: '2024-10-15', orders: 25, totalSpent: 312000, 
      avgOrderValue: 12480, status: 'at-risk', paymentTerms: 'Net 30', creditLimit: 60000, rating: 4.6
    },
    { 
      id: 6, name: 'David Wilson', email: 'david@automotive.com', phone: '+1 (555) 678-9012', 
      company: 'Automotive Parts Co', industry: 'Automotive', address: '777 Motor Drive',
      city: 'Detroit', state: 'MI', zipcode: '48201',
      joined: '2024-05-20', lastOrder: '2024-11-02', orders: 29, totalSpent: 245000, 
      avgOrderValue: 8448, status: 'active', paymentTerms: 'Net 30', creditLimit: 40000, rating: 4.5
    },
    { 
      id: 7, name: 'Jennifer Martinez', email: 'jennifer@defense.com', phone: '+1 (555) 789-0123', 
      company: 'Defense Systems', industry: 'Defense', address: '999 Security Blvd',
      city: 'Washington', state: 'DC', zipcode: '20001',
      joined: '2024-06-10', lastOrder: '2024-11-04', orders: 18, totalSpent: 425000, 
      avgOrderValue: 23611, status: 'vip', paymentTerms: 'Net 90', creditLimit: 200000, rating: 5.0
    },
    { 
      id: 8, name: 'James Taylor', email: 'james@energy.com', phone: '+1 (555) 890-1234', 
      company: 'Energy Solutions', industry: 'Energy', address: '111 Power Street',
      city: 'Houston', state: 'TX', zipcode: '77001',
      joined: '2024-07-15', lastOrder: '2024-09-20', orders: 12, totalSpent: 180000, 
      avgOrderValue: 15000, status: 'inactive', paymentTerms: 'Net 45', creditLimit: 35000, rating: 4.3
    },
  ];
  ...
  const recentOrders = [...customers].sort((a, b) => new Date(b.lastOrder).getTime() - new Date(a.lastOrder).getTime()).slice(0, 5);

  const handleAddCustomer = () => {
    console.log('Adding customer:', newCustomer);
    setShowAddDialog(false);
    setNewCustomer({
      name: '', email: '', phone: '', company: '', industry: 'Manufacturing',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage customer accounts, orders, and relationships</p>
        </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-gray-900">${(stats.avgOrderValue / 1000).toFixed(1)}K</p>
          ...
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.vipCustomers}</p>
                <p className="text-xs text-red-500 mt-1">{stats.atRiskCustomers} at risk</p>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-gray-50">
                    ...
                    <th className="text-left p-4 text-gray-700 font-semibold">Contact</th>
                    <th className="text-left p-4 text-gray-700 font-semibold">Industry</th>
                    <th className="text-left p-4 text-gray-700 font-semibold">Orders</th>
                    <th className="text-left p-4 text-gray-700 font-semibold">Total Spent</th>
                    ...
                    <tr key={customer.id} className="border-b hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-4">
                        <div>
                          ...
                          <div className="text-xs text-gray-500">Avg: ${(customer.avgOrderValue / 1000).toFixed(1)}K</div>
                        </div>
                      </td>
                      <td className="p-4">
                        <div className="flex items-center gap-1">
                          <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                          <span className="font-semibold text-gray-900">{customer.rating.toFixed(1)}</span>
                        </div>
                      </td>
            ...
            <CardContent>
              <div className="space-y-4">
                {topCustomers.map((customer, index) => (
                  <div key={customer.id} className="flex items-center gap-4 p-4 border border-gray-200 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">{customer.name}</div>
                      <div className="text-sm text-gray-600">{customer.company} • {customer.industry}</div>
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-gray-900">${(customer.totalSpent / 1000).toFixed(0)}K</div>
                      <div className="text-sm text-gray-500">Avg: ${(customer.avgOrderValue / 1000).toFixed(1)}K</div>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <TabsContent value="analytics" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="hover:shadow-md transition-shadow bg-white">
              ...
              <CardContent>
                <div className="space-y-4">
                  {(['vip', 'active', 'at-risk', 'inactive'] as const).map(status => {
                    const count = customers.filter(c => c.status === status).length;
                    const revenue = customers.filter(c => c.status === status).reduce((sum, c) => sum + c.totalSpent, 0);
                    return (
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <Card>
                  <CardContent className="p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-gray-900">${(selectedCustomer.totalSpent / 1000).toFixed(0)}K</div>
                ...
                <Card>
                  <CardContent className="p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-gray-900">${(selectedCustomer.avgOrderValue / 1000).toFixed(1)}K</div>
                ...
                <Card>
                  <CardContent className="p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-gray-900">{selectedCustomer.rating.toFixed(1)}</div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900">{selectedCustomer.paymentTerms}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Credit Limit:</span>
                      <span className="font-semibold text-gray-900">${selectedCustomer.creditLimit.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
