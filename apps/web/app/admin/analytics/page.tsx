...
import { 
  ...
  BarChart3, PieChart, Calendar, Download, FileText, Clock, Target,
  Activity, Award, Building2, Star, ArrowUpRight, Filter, Percent
} from 'lucide-react';
...
export default function AdminAnalyticsPage() {
  ...
  // Enhanced KPI data
  const kpiData = [
    { title: 'Total Revenue', value: '$2.4M', change: '+12.5%', trend: 'up', icon: DollarSign, color: 'emerald', detail: '$284K this month' },
    { title: 'Total Orders', value: '1,284', change: '+8.2%', trend: 'up', icon: ShoppingCart, color: 'blue', detail: '892 active' },
    { title: 'Active Customers', value: '342', change: '+15.3%', trend: 'up', icon: Users, color: 'purple', detail: '156 new this quarter' },
    { title: 'Avg Order Value', value: '$1,869', change: '-3.2%', trend: 'down', icon: Package, color: 'orange', detail: 'Target: $2.1K' },
    { title: 'Quote Conversion', value: '68.4%', change: '+5.2%', trend: 'up', icon: Target, color: 'cyan', detail: '428 pending' },
    { title: 'Avg Response Time', value: '2.4h', change: '-18%', trend: 'up', icon: Clock, color: 'indigo', detail: 'Under SLA' },
    { title: 'Customer Retention', value: '91.2%', change: '+2.1%', trend: 'up', icon: Award, color: 'teal', detail: '312 repeat customers' },
    { title: 'Supplier Rating', value: '4.7/5', change: '+0.2', trend: 'up', icon: Star, color: 'yellow', detail: '156 active suppliers' },
  ];
  ...
  const topCustomers = [
    { name: 'Aerospace Dynamics Corp', orders: 89, revenue: 425000, growth: 22, ltv: 892000, avgOrderValue: 4775, retention: 98 },
    { name: 'Medical Devices International', orders: 67, revenue: 380000, growth: 18, ltv: 756000, avgOrderValue: 5671, retention: 95 },
    { name: 'Automotive Systems Inc', orders: 54, revenue: 298000, growth: 15, ltv: 645000, avgOrderValue: 5519, retention: 92 },
    { name: 'Defense Technologies LLC', orders: 42, revenue: 425000, growth: 28, ltv: 987000, avgOrderValue: 10119, retention: 100 },
    { name: 'Consumer Electronics Corp', orders: 38, revenue: 312000, growth: -5, ltv: 598000, avgOrderValue: 8211, retention: 87 },
  ];

  // Supplier performance metrics
  const supplierPerformance = [
    { name: 'Precision Parts Co.', orders: 156, revenue: 89400, rating: 4.9, onTimeDelivery: 98, qualityScore: 97, responseTime: 1.8 },
    { name: 'MachineWorks Ltd.', orders: 142, revenue: 76800, rating: 4.8, onTimeDelivery: 96, qualityScore: 96, responseTime: 2.1 },
    { name: 'Advanced Manufacturing', orders: 128, revenue: 68200, rating: 4.7, onTimeDelivery: 94, qualityScore: 95, responseTime: 2.4 },
    { name: 'Quality Components Inc.', orders: 98, revenue: 52400, rating: 4.6, onTimeDelivery: 92, qualityScore: 93, responseTime: 2.8 },
    { name: 'Industrial Solutions LLC', orders: 87, revenue: 45600, rating: 4.5, onTimeDelivery: 90, qualityScore: 91, responseTime: 3.2 },
  ];

  // Order status distribution
  const ordersByStatus = [
    { status: 'Delivered', count: 542, percentage: 42, color: 'green', avgDays: 12 },
    { status: 'In Production', count: 318, percentage: 25, color: 'blue', avgDays: 7 },
    { status: 'Pending Review', count: 255, percentage: 20, color: 'yellow', avgDays: 2 },
    { status: 'Shipped', count: 127, percentage: 10, color: 'indigo', avgDays: 3 },
    { status: 'Cancelled', count: 42, percentage: 3, color: 'red', avgDays: 0 },
  ];

  // Material breakdown with revenue
  const materialBreakdown = [
    { material: 'Aluminum', orders: 485, percentage: 38, revenue: 912000, avgPrice: 1880, color: 'blue' },
    { material: 'Stainless Steel', orders: 342, percentage: 27, revenue: 768000, avgPrice: 2246, color: 'gray' },
    { material: 'Steel', orders: 256, percentage: 20, revenue: 498000, avgPrice: 1945, color: 'slate' },
    { material: 'Titanium', orders: 128, percentage: 10, revenue: 384000, avgPrice: 3000, color: 'purple' },
    { material: 'Plastic', orders: 73, percentage: 5, revenue: 87600, avgPrice: 1200, color: 'cyan' },
  ];

  // Industry breakdown
  const industryBreakdown = [
    { industry: 'Aerospace', orders: 289, revenue: 876000, percentage: 36.5, color: 'blue' },
    { industry: 'Medical', orders: 245, revenue: 612000, percentage: 25.5, color: 'red' },
    { industry: 'Automotive', orders: 198, revenue: 487000, percentage: 20.3, color: 'orange' },
    { industry: 'Defense', orders: 156, revenue: 298000, percentage: 12.4, color: 'purple' },
    { industry: 'Electronics', orders: 98, revenue: 127000, percentage: 5.3, color: 'cyan' },
  ];

  // Finish type popularity
  const finishPopularity = [
    { finish: 'Anodized Type II', count: 342, percentage: 42, avgCost: 12, color: 'blue' },
    { finish: 'Powder Coating', count: 256, percentage: 31, avgCost: 8, color: 'green' },
    { finish: 'Bead Blasting', count: 124, percentage: 15, avgCost: 6, color: 'purple' },
    { finish: 'Chrome Plating', count: 67, percentage: 8, avgCost: 18, color: 'gray' },
    { finish: 'As Machined', count: 34, percentage: 4, avgCost: 0, color: 'slate' },
  ];

  // Conversion funnel
  const conversionFunnel = [
    { stage: 'Uploads', count: 2847, percentage: 100, color: 'blue' },
    { stage: 'Quotes Generated', count: 1924, percentage: 67.6, color: 'purple' },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {kpiData.map((kpi) => {
          ...
          return (
            <Card key={kpi.title} className="bg-white hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className={`text-xs font-semibold ${kpi.trend === 'up' ? 'text-green-600' : 'text-red-600'}`}>{kpi.change}</span>
                  </div>
                </div>
                ...
                <div key={item.month} className="space-y-2">
                    ...
                    <div className="flex items-center gap-6">
                      {(chartView === 'revenue' || chartView === 'both') && (
                        <span className="text-gray-600">
                          <span className="font-semibold text-emerald-600">${(item.revenue / 1000).toFixed(0)}K</span>
                        </span>
                      )}
                      {(chartView === 'orders' || chartView === 'both') && (
                        <span className="text-gray-600">
                          <span className="font-semibold text-blue-600">{item.orders}</span> orders
                        </span>
                      )}
                      <span className="text-gray-500 text-xs">{item.quotes} quotes</span>
                    </div>
                  </div>
                  ...
                  {chartView === 'both' ? (
                    ...
                    <div className="relative h-10 bg-gray-100 rounded-lg overflow-hidden">
                      ...
                      >
                        {revenueHeight > 25 && (
                          <span className="text-sm font-semibold text-white">${(item.revenue / 1000).toFixed(0)}K</span>
                        )}
                      </div>
                    </div>
                  ) : (
                    <div className="relative h-10 bg-gray-100 rounded-lg overflow-hidden">
                      ...
                      >
                        {ordersHeight > 25 && (
                          <span className="text-sm font-semibold text-white">{item.orders}</span>
                        )}
                      </div>
                    </div>
                  )}
                  ...
                  <div key={stage.stage}>
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        ...
                        {dropoffPercentage && parseFloat(dropoffPercentage) > 0 && (
                ...
                return (
                  <div key={item.status}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-xs text-gray-500">{item.avgDays}d avg</span>
                ...
                <div key={idx} className="p-4 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs text-gray-600">${(customer.ltv / 1000).toFixed(0)}K LTV</span>
                        </div>
                      </div>
                    </div>
                    <div className="text-right">
                      ...
                      <div className="flex items-center gap-1 justify-end mt-1">
                        <TrendingUp className={`w-3.5 h-3.5 ${customer.growth >= 0 ? 'text-green-600' : 'text-red-600'}`} />
                        <span className={`text-xs font-semibold ${customer.growth >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-xs">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">${(customer.avgOrderValue / 1000).toFixed(1)}K</p>
                    </div>
                    <div>
              ...
              {supplierPerformance.map((supplier, idx) => (
                <div key={idx} className="p-4 bg-gray-50 rounded-lg hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs font-semibold text-gray-900">{supplier.rating}</span>
                          </div>
                          <span className="text-xs text-gray-500">•</span>
                    ...
                    <div className="text-right">
                      <p className="font-bold text-gray-900">${(supplier.revenue / 1000).toFixed(1)}K</p>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-xs">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-blue-600">{supplier.qualityScore}%</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Response</p>
                      <p className="font-semibold text-purple-600">{supplier.responseTime}h</p>
                    </div>
                  </div>
                </div>
              ))}
                ...
                return (
                  <div key={item.material}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-semibold text-gray-900">{item.orders}</p>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Avg: ${item.avgPrice}/order</p>
                  </div>
                );
              })}
            </div>
            ...
            <div className="space-y-4">
              {finishPopularity.map((item) => {
                ...
                return (
                  <div key={item.finish}>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-gray-700 truncate">{item.finish}</span>
                      <div className="text-right">
                        <p className="text-sm font-semibold text-gray-900">{item.count}</p>
                        <p className="text-xs text-gray-500">${item.avgCost}/part</p>
                      </div>
                    </div>
                    <div className="relative h-2.5 bg-gray-100 rounded-full overflow-hidden">
                      <div 
                    ...
                    <p className="text-xs text-gray-500 mt-1">{item.percentage}% of orders</p>
                  </div>
                );
              })}
            </div>
