    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Manage and monitor supplier performance</p>
        </div>
        ...
        <Card className="bg-white border-gray-200 shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">{stats.activeSuppliers}</p>
            </div>
        ...
        <Card className="bg-white border-gray-200 shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">${(stats.totalRevenue / 1000000).toFixed(1)}M</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {filteredSuppliers.map((supplier) => (
          <Card key={supplier.id} className="bg-white border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow">
            {/* Header */}
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-blue-500">{supplier.activeOrders}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600">Revenue</p>
                <p className="text-lg font-semibold text-green-500">${(supplier.revenue / 1000).toFixed(0)}K</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-4">
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className={`text-xs font-medium ${getCapacityColor(supplier.capacity)}`}>
                    {supplier.capacity}%
                  </span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gray-50 rounded-lg p-2">
                  ...
                  <p className="text-sm font-semibold text-gray-900">{supplier.onTimeDelivery}%</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-2">
                  <div className="flex items-center gap-1 text-xs text-gray-600 mb-1">
                  ...
                  <p className="text-sm font-semibold text-gray-900">{supplier.qualityScore}%</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {supplier.specialties.map((specialty, idx) => (
                  <Badge key={idx} className="bg-blue-500/10 text-blue-500 border-blue-500/20 border text-xs">
                    {specialty}
                  </Badge>
                ))}
              </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {supplier.certifications.map((cert, idx) => (
                  <Badge key={idx} className="bg-green-500/10 text-green-500 border-green-500/20 border text-xs">
                    {cert}
                  </Badge>
                ))}
              </div>
