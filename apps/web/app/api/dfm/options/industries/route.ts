import { IndustryListVNextSchema } from '@cnc-quote/shared/contracts/vnext';
...
const buildUrl = (): string => {
  ...
  const url = new URL('/admin/dfm/options/industries', base.replace(/\/$/, ''));
...
export async function GET(request: Request) {
  ...
  return forwardJsonWithSchema(upstream, IndustryListVNextSchema);
}
