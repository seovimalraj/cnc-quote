import { ToleranceListVNextSchema } from '@cnc-quote/shared/contracts/vnext';
...
const buildUrl = (): string => {
  ...
  const url = new URL('/admin/dfm/options/tolerances', base.replace(/\/$/, ''));
...
export async function GET(request: Request) {
  ...
  return forwardJsonWithSchema(upstream, ToleranceListVNextSchema);
}
