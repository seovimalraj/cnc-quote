import { FinishListVNextSchema } from '@cnc-quote/shared/contracts/vnext';
...
const buildUrl = (): string => {
  ...
  const url = new URL('/admin/dfm/options/finishes', base.replace(/\/$/, ''));
...
export async function GET(request: Request) {
  ...
  return forwardJsonWithSchema(upstream, FinishListVNextSchema);
}
