import { CriticalityListVNextSchema } from '@cnc-quote/shared/contracts/vnext';
...
const buildUrl = (): string => {
  ...
  const url = new URL('/admin/dfm/options/criticality', base.replace(/\/$/, ''));
...
export async function GET(request: Request) {
  ...
  return forwardJsonWithSchema(upstream, CriticalityListVNextSchema);
}
