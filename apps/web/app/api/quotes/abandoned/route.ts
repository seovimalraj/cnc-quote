...
import { abandonedQuotes, type AbandonedQuoteData } from '../../../../lib/storage'
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`Saved abandoned quote ${abandonedData.quoteId} at step ${abandonedData.currentStep}`, {
...
export async function GET(request: NextRequest) {
  try {
    ...
    userQuotes.sort((a, b) => new Date(b.abandonedAt).getTime() - new Date(a.abandonedAt).getTime())
